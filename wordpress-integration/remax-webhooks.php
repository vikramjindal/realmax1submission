...
function remax_send_webhook($post_id, $post, $update) {
    ...
    $custom_post_types = array('remax_agent', 'remax_team', 'remax_testimonial', 'remax_section', 'remax_marketing', 'remax_mkt_service', 'remax_event', 'remax_past_event', 'remax_training');
